...
export default function PrivacyPage() {
  return (
    <main className="prose-jv mx-auto max-w-3xl px-5 py-10">
      ...
      <p>
        Lesson progress, quiz scores, your certificate name, Pro demo flag, and
        theme preference are stored in <code>localStorage</code> on your device.
        We do not receive that data unless you later create an account (not
        required for the free curriculum).
      </p>
      <h2>Newsletter</h2>
      <p>
      ...
      <p>
        ...
        cookies and collect usage data under their policies. Pro members can
        hide ad slots on this site.
      </p>
